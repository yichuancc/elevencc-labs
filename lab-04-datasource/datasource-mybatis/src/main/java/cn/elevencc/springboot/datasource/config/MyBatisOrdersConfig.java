package cn.elevencc.springboot.datasource.config;
...
@Configuration
@MapperScan(basePackages = "cn.elevencc.springboot.datasource.mapper.orders", sqlSessionTemplateRef = "ordersSqlSessionTemplate")
public class MyBatisOrdersConfig {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        // 设置 entity 所在包
        bean.setTypeAliasesPackage("cn.elevencc.springboot.datasource.pojo");
        // 设置 config 路径
